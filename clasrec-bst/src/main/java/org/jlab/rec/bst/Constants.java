...
public class Constants {
    ...
    public static double detMatZ_ov_A_timesThickn =  (14.*2*SILICONWIDTH/28.0855+Z_eff_roha*RohacellThick/12.0588+6*CaThick/12.0107) ;
	//...................
	...
	public static final double BFCorrFac = 1.0;
	...
	public static synchronized void Load() {
		...
		PHI0[0] = Math.toRadians(90.);
		PHI0[1] = Math.toRadians(90.);
		PHI0[2] = Math.toRadians(90.);
		PHI0[3] = Math.toRadians(90.);
		PHI0[4] = Math.toRadians(90.);
		PHI0[5] = Math.toRadians(90.);
		PHI0[6] = Math.toRadians(90.);
		PHI0[7] = Math.toRadians(90.);
...

		{
			...
			for(int layer = 1; layer <=8; layer ++){
				...
				for(int sector = 1; sector <= Constants.NSECT[layer-1]; sector ++){
					...
					double x0 = geo.getPlaneModuleOrigin( layer,  sector).x();
					double y0 = geo.getPlaneModuleOrigin( layer,  sector).y();
					double x1 = geo.getPlaneModuleEnd(layer, sector).x();
					double y1 = geo.getPlaneModuleEnd(layer, sector).y();
				
					double[] z = new double[6];
					z[0] = geo.getPlaneModuleOrigin( layer,  sector).z();
					z[1] = (geo.getPlaneModuleOrigin( layer,  sector).z()+Constants.ACTIVESENLEN);
					z[2] = (geo.getPlaneModuleOrigin( layer,  sector).z()+Constants.ACTIVESENLEN+1*Constants.DEADZNLEN);
					z[3] = (geo.getPlaneModuleOrigin( layer,  sector).z()+2*Constants.ACTIVESENLEN+1*Constants.DEADZNLEN);
					z[4] = (geo.getPlaneModuleOrigin( layer,  sector).z()+2*Constants.ACTIVESENLEN+2*Constants.DEADZNLEN);
					z[5] = (geo.getPlaneModuleOrigin( layer,  sector).z()+3*Constants.ACTIVESENLEN+2*Constants.DEADZNLEN);
